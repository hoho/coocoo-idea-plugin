...
public class CoocooSyntaxHighlighter extends SyntaxHighlighterBase {
    ...
    public static final TextAttributesKey COONAME = createTextAttributesKey("COOCOO_NAME", DefaultLanguageHighlighterColors.INSTANCE_METHOD);
    ...
    private static final TextAttributesKey[] COONAMES = new TextAttributesKey[]{COONAME};
    ...
    public TextAttributesKey[] getTokenHighlights(IElementType tokenType) {
        if (tokenType.equals(CoocooTypes.KEYWORD)) {
            ...
            return COOCLASSES;
        } else if (tokenType.equals(CoocooTypes.COONAME)) {
            return COONAMES;
